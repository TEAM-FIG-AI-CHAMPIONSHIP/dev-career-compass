...
- 토스는 RSS가 20건 상한이고 sitemap.xml은 404다. 이번 20건은 2026-06-23 ~
  2026-09-09(약 2.5개월)뿐이다. 12개월 창이 아니다.
- 가비아는 RSS가 10건 상한이고, 수집 기간은 약 1개월(2026-08-07 ~ 2026-09-08)
  뿐이다. 그 10건 중 HR·행사·멘토링 후기를 수기로 걸러 기술글 4건이 남았다.
  글이 원래 적어서가 아니라, 한 달치만 보고 그중 비기술 글이 많아서다.
- 토스·가비아는 자체 호스팅(Next.js/워드프레스 계열)이라 당근의 원인
  (Cloudflare)과는 다르다. 증상은 같다: RSS 항목 수 상한 때문에 실제보다 훨씬
  짧은 기간만 수집됐다. sitemap 없음은 확인했고, 당근처럼 Wayback 시도는
  이번 이슈에서 하지 않았다. 이 Area도 그 스냅샷 안에서만 해석한다.
- 넥스트리는 12개월 창이 짧은 스냅샷이다. 이 Area도 그 범위 안에서만 해석한다.
